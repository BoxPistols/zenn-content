...
ただし**全部そろっていることは、その全部が意図どおりであることを意味しません**。全部がDESIGN.mdと真逆でも、そろっている数は変わりません。

そろえたことと正しいことは別です。「チェックを入れた」「そろっている数を増やした」で安心する構造は、上の表とまったく同じ形をしています。
...
一番危ないのは、できていないのに検査が通ってしまうことです。エラーも出ず、数のうえでは全部そろっていて、出力は自信ありげです。
